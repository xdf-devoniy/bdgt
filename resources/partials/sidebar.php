...
<aside class="d-none d-md-flex flex-column bg-white border-end shadow-sm" style="width: 240px;">
    ...
    <nav class="nav flex-column p-2 gap-1">
        <?php
        $links = [
            ['label' => 'Overview', 'href' => '/?page=dashboard', 'icon' => 'bi-speedometer2', 'key' => 'dashboard'],
            ['label' => 'Transactions', 'href' => '/?page=transactions', 'icon' => 'bi-table', 'key' => 'transactions'],
            ['label' => 'Budgets', 'href' => '/?page=budgets', 'icon' => 'bi-bullseye', 'key' => 'budgets'],
            ['label' => 'Reports', 'href' => '/?page=reports', 'icon' => 'bi-pie-chart', 'key' => 'reports'],
            ['label' => 'Wallets', 'href' => '/?page=wallets', 'icon' => 'bi-wallet2', 'key' => 'wallets'],
            ['label' => 'Goals', 'href' => '/?page=goals', 'icon' => 'bi-flag', 'key' => 'goals'],
            ['label' => 'Settings', 'href' => '/?page=settings', 'icon' => 'bi-gear', 'key' => 'settings'],
        ];
